defmodule GeneratorWeb.Sidebar do
       ...
       <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
        ...
        <div class="mt-5 flex flex-grow flex-col">
          <nav class="flex-1 space-y-1 px-2 pb-4">
                <a href="#" phx-click="change-screen" phx-target={@myself} phx-value-screen="users" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                ...
                <a href="#" phx-click="change-screen" phx-target={@myself} phx-value-screen="plans" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-gray-400 group-hover:text-gray-500 mr-4 flex-shrink-0 h-6 w-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859m-19.5.338V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 00-2.15-1.588H6.911a2.25 2.25 0 00-2.15 1.588L2.35 13.177a2.25 2.25 0 00-.1.661z" />
                </svg>
                  Plans
  ...
  defp redirect(socket) do
    case socket.assigns.screen do
      "users" -> push_redirect(socket, to: Routes.user_index_path(socket, :index))
      ...
      "plans" -> push_redirect(socket, to: Routes.plan_index_path(socket, :index))
